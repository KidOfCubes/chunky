...
public class SahBVH extends BinaryBVH {
    public static void registerImplementation() {
        Factory.addBVHBuilder(new Factory.BVHBuilder() {
            ...
            public BVH create(Collection<Entity> entities, Vector3 worldOffset, Scene mainScene, TaskTracker.Task task) {
                ...
                return new SahBVH(allPrimitives, mainScene, i -> task.updateInterval((int) (i * primitiveScaler) + 500, 1));
            }
    ...
    public SahBVH(Primitive[] primitives, Scene mainScene, IntConsumer task) {
        super(mainScene);
